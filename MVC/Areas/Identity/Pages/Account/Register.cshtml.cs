        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.Role_Storage))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.Role_Storage));
                    }
                    if(user.Role == null)
                    {
                    ...
                    else
                    {
                        ...
                        {
                            //Aqui el administrador esta registrando un nuevo usuario,
